...
- Finding Russian practice beyond class.
- Understanding language scholarship options like CLS.
...
- Faculty Coordinator for the [Critical Language Scholarship Program](https://clscholarship.org/) (Russian is one of the supported languages).
- 2022 Recognition for Teaching Excellence from the Arnold L. and Lois S. Graves Award.

## Useful Links

- [Lewis & Clark faculty profile](https://college.lclark.edu/live/profiles/7132-maria-hristova)
- [Critical Language Scholarship Program](https://clscholarship.org/)
- [Russian Language Opportunities](../opportunities/russian.md)

## Related Guides

- [Questions for Faculty](questions.md)
